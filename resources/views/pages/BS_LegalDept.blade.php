...
<div class="hed"> <h2>Legal Department</h2> </div>
     <div class="container" >
     
<div class="row">
<div class="col-md-9">
<div class="jumbotron" id="legal">
    <h1>IMG</h1> 
    <p> image holder</p> 
  </div>
    ...
    <div class="col-md-3" style="margin-top:0.4cm;">
	  <div class="list-group"> 
            ...
            <a href="BS_HumanResource" class="list-group-item ">Human Resources</a> 

            <a href="BS_LegalDept" class="list-group-item active">Legal Department</a> 
