...
<div class="hed"> <h2>Construction</h2> </div>
     <div class="container" >
     
<div class="row">
<div class="col-md-9">
<div class="jumbotron" id="construction">
  </div>
    ...
    <div class="col-md-3" style="margin-top:0.4cm;">
	   ...
	   <div class="list-group"> 
            ...
            <a href="I_Finance" class="list-group-item">Finance</a> 
		...
		<a href="I_Construction" class="list-group-item active">Construction</a>
