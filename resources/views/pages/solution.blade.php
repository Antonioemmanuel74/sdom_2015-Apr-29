      ...
      <div class="row row-offcanvas row-offcanvas-right"> 
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"> 
          ...
          <div class="list-group"> 
            ...
            <a href="#" class="list-group-item active">Industry</a> 

            <a href="#" class="list-group-item">Finance</a> 
            ...
            <a href="#" class="list-group-item">Associations</a> 
	    ...
	    <a href="#" class="list-group-item active">Business Solution</a> 

            <a href="#" class="list-group-item">Accounts</a> 

            <a href="#" class="list-group-item">Human Resource</a> 
	    ...
	    <a href="#" class="list-group-item">Digital Conversion</a> 
          ...
          <div class="row" style="margin-right:7cm; margin-top:0cm; margin-left:0.3cm;"> 
...
<div style="width:30cm; height:2cm; background-color:#ebebeb; margin-left:3cm">
    
    <p>an abstract image sits here</p>
</div>
